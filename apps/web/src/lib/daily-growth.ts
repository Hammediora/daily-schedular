...
const PROMPT = `Generate today's personal growth brief as a JSON object. Return ONLY valid JSON — no markdown fences, no explanation, no extra text before or after.
