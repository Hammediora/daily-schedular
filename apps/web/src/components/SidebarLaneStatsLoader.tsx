...
import SidebarLaneBars from "./SidebarLaneBars";
...
export default async function SidebarLaneStatsLoader({ workspaceId }: { workspaceId: string }) {
  ...
  const stats = (["REVENUE", "ASSET", "LEVERAGE", "HEALTH"] as const).map(lane => {
  ...
  return <SidebarLaneBars stats={stats} />;
}
